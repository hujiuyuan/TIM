...
import com.hjy.tim.client.vo.req.GroupReqVO;
import com.hjy.tim.client.vo.req.LoginReqVO;
import com.hjy.tim.client.vo.req.P2PReqVO;
import com.hjy.tim.client.vo.res.OnlineUsersResVO;
import com.hjy.tim.client.vo.res.TIMServerResVO;
import com.hjy.tim.client.config.AppConfiguration;
import com.hjy.tim.client.service.EchoService;
import com.hjy.tim.client.service.RouteRequest;
import com.hjy.tim.client.thread.ContextHolder;
...
public class RouteRequestImpl implements RouteRequest {
    ...
    public void sendP2PMsg(P2PReqVO p2PReqVO) throws Exception {
        RouteApi routeApi = new ProxyManager<>(RouteApi.class, gatewayUrl, okHttpClient).getInstance();
        com.hjy.tim.gateway.api.vo.req.P2PReqVO vo = new com.hjy.tim.gateway.api.vo.req.P2PReqVO();
    ...
    public TIMServerResVO.ServerInfo getTIMServer(LoginReqVO loginReqVO) throws Exception {
        ...
        RouteApi routeApi = new ProxyManager<>(RouteApi.class, gatewayUrl, okHttpClient).getInstance();
        com.hjy.tim.gateway.api.vo.req.LoginReqVO vo = new com.hjy.tim.gateway.api.vo.req.LoginReqVO();
